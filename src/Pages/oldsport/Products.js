...
const Products = () => {
  ...
  useEffect(() => {
    fetch("https://creepy-chupacabra-59453.herokuapp.com/products")
  ...
  const handleDeleteProduct = (id) => {
    ...
    fetch(`https://creepy-chupacabra-59453.herokuapp.com/deleteProduct/${id}`, {
      method: "DELETE",
  ...
  const handleAddToCart = (index) => {
    ...
    fetch(`https://creepy-chupacabra-59453.herokuapp.com/addOrders`, {
      method: "POST",
      headers: { "content-type": "application/json" },
